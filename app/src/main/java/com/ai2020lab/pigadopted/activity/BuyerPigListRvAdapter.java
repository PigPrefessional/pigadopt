...
public class BuyerPigListRvAdapter extends BuyerPigListAdapter<BuyerPigListRvAdapter.ItemViewHolder> {
	 ...
	 * 设置猪图片
	 */
	private void setBuyerPigIv(PigDetailInfoForBuyer pigInfo, ImageView buyerPigIv) {
	 ...
	 * 设置猪当前猪龄
	 */
	private void setBuyerPigAgeTv(PigDetailInfoForBuyer pigInfo,
	 ...
	 * 设置猪体重数据
	 */
	private void setBuyerPigWeightTv(PigDetailInfoForBuyer pigInfo,
	 ...
	 * 设置猪卖家名字
	 */
	private void setSellerNameTv(PigDetailInfoForBuyer pigInfo,
	...
	private void setLineVisible(int position, ImageView lineLeftUpIv,
		...
		// 第一条数据，隐藏左上和右上的绳子
		if (position == 0) {
			lineLeftUpIv.setVisibility(View.GONE);
			lineRightUpIv.setVisibility(View.GONE);
