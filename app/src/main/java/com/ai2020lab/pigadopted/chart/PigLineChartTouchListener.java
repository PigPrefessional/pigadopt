 ...
 */
public class PigLineChartTouchListener extends ChartTouchListener<BarLineChartBase<? extends BarLineScatterCandleBubbleData<? extends IBarLineScatterCandleBubbleDataSet<? extends Entry>>>> {
    ...
    public PigLineChartTouchListener(BarLineChartBase<? extends BarLineScatterCandleBubbleData<? extends IBarLineScatterCandleBubbleDataSet<? extends Entry>>> chart, Matrix touchMatrix) {
        super(chart);
        ...
        if (event.getPointerCount() >= 2) {
            ...
            if (totalDist > 10f) {
                ...
                if (mTouchMode == PINCH_ZOOM) {
                    ...
                    if (l != null)
                        l.onChartScale(event, scale, scale);
