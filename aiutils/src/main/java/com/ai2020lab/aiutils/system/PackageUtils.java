...
/**
 * 应用包工具类，提供展示应用版本号，安装应用等功能
 * <ul>
 * <strong>获取应用包名，版本号</strong>
 * <li>{@link PackageUtils#getAppPackageName(Context)}</li>
 * <li>{@link PackageUtils#getAppVersion(Context)}</li>
 * <li>{@link PackageUtils#getAppVersion(Context)}</li>
 * </ul>
 * <ul>
 ...
 * <li>{@link PackageUtils#startInstalledAppDetails(Context, String)}
 * start InstalledAppDetails Activity</li>
 * <strong>Others</strong>
 * <li>{@link PackageUtils#isInstalled(Context, String)}} judge app is installed</li>
 * </ul>
...
public class PackageUtils {
	...
	/**
	 * 获取AndroidManifest.xml配置文件中package
	 *
	 * @param context 上下文引用
	 * @return 返回应用包名
	 */
	public static String getAppPackageName(Context context) {
		...
		try {
			...
			LogUtils.e(TAG, "获取应用包名异常", e);
		}
		return packageName;
	}

	/**
	 * 获取AndroidManifest.xml配置文件中android:versionCode
	 *
	 * @param context 上下文引用
	 * @return 返回应用build版本号
	 */
	public static int getAppVersion(Context context) {
		try {
			...
			LogUtils.e(TAG, "获取应用versionCode异常", e);
		}
		return -1;
	}

	/**
	 * 获取AndroidManifest.xml配置文件中android:versionName
	 *
	 * @param context 上下文引用
	 * @return 返回应用外部版本号
	 */
	public static String getAppVersionName(Context context) {
		...
		try {
			...
			LogUtils.e(TAG, "获取应用versionName异常", e);
		}
		return version;
	}
